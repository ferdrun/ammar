...
<table border="0" width="100%">
	...
	?>
	<tr>
		<td><img src="<?php echo BASE_URL; ?>media/products/<?php echo $item['image']; ?>" width="70" /></td>
		<td><?php echo $item['name']; ?></td>
		<td> <?php echo($item['sz']);?></td>
	...
	<tr>
		...
		<td colspan="3"><strong>R$ <?php echo number_format($subtotal, 2, ',', '.'); ?></strong></td>
	</tr>
	<tr>
		<td colspan="3" align="right">Frete:</td>
		<td colspan="3">
			<?php if(isset($shipping['price'])): ?>
				<strong>R$ <?php echo number_format($shipping['price'], 2, ',','.'); ?></strong> (<?php echo $shipping['date']; ?> dia<?php echo ($shipping['date']=='1')?'':'s'; ?>)
			<?php else: ?>
				Qual seu CEP?<br/>
				<form method="POST">
