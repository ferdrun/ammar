...
public function setAmount($amount) {
    $this->amount = (string)number_format($amount,3,'.','');
    return $this;
}
...
/**
 * Metódo responsável por retornar os valores completos da informação da conta 
 * @return string
 */
private function getMerchantAccountInformation() {
    //Domínio do banco
    $gui = $this->getValue(self::ID_MERCHANT_ACCOUNT_INFORMATION_GUI,'0014br.gov.bcd.pix');
...
/**
 * Método responável por retornar os valores completos do campo adicional do pix (TXID)
 * @return string
 */
...
public function getPayload() {
    ...
    $payload = $this->getValue(self::ID_PAYLOAD_FORMAT_INDICATOR,'01').
               ...
               $this->getValue(self::ID_COUNTRY_CODE, '5802BR').
